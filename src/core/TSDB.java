...
public final class TSDB {
    ...
    private Deferred<Object> addPointInternal(final String metric,
        ...
        if (config.enable_appends()) {
            ...
            scheduleForCompaction(row, (int) base_time);
            LOG.info("insert into hbase ");

//            AtomicIncrementRequest atomicIncrementRequest = new AtomicIncrementRequest(table, row, FAMILY, qualifier);
//            atomicIncrementRequest.setAmount(Long.valueOf(new String(value)));
//            client.atomicIncrement(atomicIncrementRequest);
